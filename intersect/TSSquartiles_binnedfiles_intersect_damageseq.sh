...
OUTPUT_DIR="../output/TSSquartile/damage"  # Change this to your desired output directory
...
SAMPLES=($(find "${damageSEQ_DIR}" -name "*.bed"))
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    QUARTILE_FILES=(
        "${GENELIST_DIR}/TSS_wt_0_25_quartile_final_150bins.bed"
        "${GENELIST_DIR}/TSS_wt_25_50_quartile_final_150bins.bed"
        "${GENELIST_DIR}/TSS_wt_50_75_quartile_final_150bins.bed"
        "${GENELIST_DIR}/TSS_wt_75_100_quartile_final_150bins.bed"
    )
