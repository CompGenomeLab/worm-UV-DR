...
OUTPUT_DIR="../output/genebodyintersect/xr"  # Change this to your desired output directory
...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    QUARTILE_FILES=(
        "${GENELIST_DIR}/${STRAIN}_0_25_quartile.bed"
        "${GENELIST_DIR}/${STRAIN}_25_50_quartile.bed"
        "${GENELIST_DIR}/${STRAIN}_50_75_quartile.bed"
        "${GENELIST_DIR}/${STRAIN}_75_100_quartile.bed"
    )
